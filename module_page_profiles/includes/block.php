		...
		<div class="profile_block_content">
			<div class="profile_block_about_player max_height fix_gap">
				...
				<?php else : ?>
					<div class="bans_comms_header">
						...
						<span class="bans_comms_none"><?= $Translate->get_translate_module_phrase('module_page_profiles', '_Bans_Length'); ?></span>
								...
								<span class="bans_comms_none">
									<?php
										if ($SBBans[$i]['duration'] == 0){ 
											echo '<div class="color-red">' . $Translate->get_translate_module_phrase('module_page_profiles', '_Forever') . '</div>'; 
										} else { 
											echo '<div class="color-gray">'. $Modules->action_time_exchange($SBBans[$i]['end_mute_time'] - $SBBans[$i]['start_mute_time']) ."</div>";
										}
									?>
								</span>
								<span>
			...
			<div class="profile_block_about_player max_height fix_gap">
				...
				<?php else : ?>
					<!-- 2 -->
					<div class="bans_comms_header">
						<span class="bans_comms_none"><?= $Translate->get_translate_module_phrase('module_page_profiles', '_Comms_Type'); ?></span>
						<span class="bans_comms_none"><?= $Translate->get_translate_module_phrase('module_page_profiles', '_Bans_Data'); ?></span>
						<span><?= $Translate->get_translate_module_phrase('module_page_profiles', '_Bans_Reason'); ?></span>
						<span class="bans_comms_none"><?= $Translate->get_translate_module_phrase('module_page_profiles', '_Bans_Admin'); ?></span>
						<span><?= $Translate->get_translate_module_phrase('module_page_profiles', '_Expiration'); ?></span>
